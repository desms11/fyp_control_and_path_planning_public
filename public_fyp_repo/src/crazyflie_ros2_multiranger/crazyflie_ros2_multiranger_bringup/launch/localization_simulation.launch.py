...
def generate_launch_description():
    ...
    map_arg = DeclareLaunchArgument(
        ...
        description='Absolute path to the saved raster map yaml file',
    )

    rviz_arg = DeclareLaunchArgument(
        'rviz',
        default_value='true',
        description='Open RViz for localization',
    )
    ...
    # Bridge scan frame into TF tree used by AMCL and RViz.
    scan_static_tf = Node(
        package='tf2_ros',
        executable='static_transform_publisher',
        name='scan_static_tf_localization',
